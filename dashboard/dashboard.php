<?php 
	$connect=mysqli_connect("localhost","root","","111");
        ...
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
               ...
               <ul class="list-group">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/davevaibhavi/home" target="_blank">Google Site</a></li>
                    ...
                    <li class="list-group-item"><a href="https://github.com/davevaibhavi/web_php_script" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                ...
                <div class="container">
                    <div class="dashboard-item">
                        ...
                        <p>My name is vaibhavi dave. I graduated with a Computer degree in 2023 in m.v.m college I had worked with  as web developer </p>
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
<button class="ocean-blue-button gradient-button"><a href="https://github.com/davevaibhavi/web_php_script/tree/main/task_1">Task 1</a></button>
<button class="ocean-blue-button gradient-button"><a href="https://github.com/davevaibhavi/web_php_script/tree/main/task2">Task 2</button>
<button class="ocean-blue-button gradient-button"><a href="https://github.com/davevaibhavi/web_php_script/tree/main/task3">Task 3</button>
<button class="ocean-blue-button gradient-button"><a href="https://github.com/davevaibhavi/web_php_script/tree/main/array">Task 4</button>
...
<button class="spring-green-button gradient-button">Database  Module</button>
                    ...
                    <div class="dashboard-item">
                        ...
                        <p>evergreen nursery and AMUL </p>
                    </div>
                </div>
            </main>
        </div>
